"""
usage: python3 dual_m.py --m=<mass> --M=<mass> --K=<K> --Ensemble=<Ensemble> --Backward=<True or False> --Outpath=<path>
...
For Example,
> sbatch single_m.sh --m=0.000000000 --M=0.000000000 --K=0.000000000 --Ensemble=1 --Backward=True --Outpath=Dual-mass-comparing
--------------------
"""
...
params['K'] = 1.
params['Ensemble'] = 128
params['out_path'] = 'Dual-mass-comparing'
